    ...
    const inputHandler = async (e) => {
        try {
            ...
            if (input) {
                ...
                setShowSearch(false);
                setUser(null); // Clear user when input is empty
            }
        } catch (error) {
    ...
    const addChat=async()=>
    {
        ...
        try{
            ...
            await setDoc(newMessageRef,{
                createAt:serverTimestamp(),messages:[]
            })
        ...
        <div className="ls-list">
            {showSearch && user ? (
                ...
                Array.isArray(chatData) && chatData.length > 0 ? (
                    ...
                    <p>No chats available</p> // Display a message if chatData is empty or not an array
                )
            )}
        </div>
    </div>
